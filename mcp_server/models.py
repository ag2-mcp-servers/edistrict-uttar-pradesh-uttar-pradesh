...
class CertificateParameters(BaseModel):
    ApplicationNo: str = Field(..., description='ApplicationNo', examples=['1234'])
    CertificateID: str = Field(..., description='CertificateID', examples=['2345'])
...
class CertificateParameters1(BaseModel):
    ApplicationNo: str = Field(..., description='Application No', examples=['1234'])
    CertificateID: str = Field(..., description='Certificate ID', examples=['6789'])
...
class CertificateParameters2(BaseModel):
    ApplicationNo: str = Field(..., description='Application No', examples=['1234'])
    CertificateID: str = Field(..., description='Certificate ID', examples=['2345'])
...
class CertificateParameters3(BaseModel):
    ApplicationNo: str = Field(
        ..., description='Application No', examples=['1213232332']
    )
    CertificateID: str = Field(
        ..., description='Certificate ID', examples=['213232232']
    )
...
class CertificateParameters5(BaseModel):
    ApplicationNo: str = Field(
        ..., description='ApplicationNo', examples=['Application No']
    )
    CertificateID: str = Field(
        ..., description='CertificateID', examples=['CertificateID']
    )
